...
This capability covers the testing infrastructure for the Atom game using Jest for unit tests and Playwright for E2E tests. It defines test configuration, file organization, coverage requirements for server and client code, watch mode, mocking conventions, example tests, and npm script integration.
